...
public:
    ...
    bool setFocusArea(const ptzf::FocusArea focus_area, const u32_t seq_id = DEFAULT_SEQ_ID);
    ...
    bool setPtMiconPowerOnCompStatus(const bool complete, const u32_t seq_i = DEFAULT_SEQ_ID);
